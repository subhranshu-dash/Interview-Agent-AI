...
import { BsMic, BsRobot ,BsClock} from 'react-icons/bs';
        ...
        <div className='flex flex-col md:flex-row justify-center items-center gap-10 mb-28'>
          {
           ...
           { icon:<BsRobot size={24}/>,
             step:"STEP 1",
             titel :"Role & Experience Selecton",
             desc : "AI adjusts difficulty based on selected job role"

            },
            { icon:<BsMic size={24}/>,
             step:"STEP 2",
             titel :"Smart Voice Interview",
             desc : "Dynamic follow-up question based on your answers"

            },
            { icon:<BsClock size={24}/>,
             step:"STEP 3",
             titel :"Time Based Simulation",
            ...
            // pending+
             ...
             `}>
              ...
              <div className='pt-10 text-center'>
                ...
                <h3 className='font-semibold mb-3 text-lg'>{item.titel}</h3>
              ...
              [
                {
                 ...
                 titel:"Ai Answar Evalution",
                 desc:"Scores communication,technical accuracy and confidence."
                },
                {
                  image:resumeImg,
                 icon :<BsFileEarmarkText size={20}/>,
                 titel:"Resume Based Interview",
                ...
                },
                {
                  image:pdfImg,
                 icon :<BsFileEarmarkText size={20}/>,
                 titel:"Downloadable pdf Report",
                 desc:"Detailed strength , weakness and improvement insights."
                },
                {
                  image:analyticsImg,
                 icon :<BsBarChart size={20}/>,
                 titel:"History & Analytics",
                 desc:"Track progress with performance graphs and topic."
                }
              ].map((item ,index)=>(
                <motion.div key={index}
                ...
                className='bg-white border border-gray-2 rounded-3xl p-8 shadow-sm hover:shadow-xl transition-all'>
                  <div className='flex flex-col md:flex-row items-center gap-8'>
                     <div className='w-full md:w-1/2 flex justify-center'>
                     <img src={item.image} alt={item.titel} className='w-full h-auto object-contain max-h-64' />
                     </div>
                     ...
                     <div className='w-full md:w-1/2'>
                        ...
                        <h3 className='font-semibold mb-3 text-xl'>{item.titel} </h3>
          ...
          <div className=' grid md:grid-cols-2 gap-10'>
            {
              [
                {
                 image:hrImg,
                 titel:"HR Interview Mode",
                 desc:"Behavioral and communication based evaluation."
                },
                {
                image:techImg,
                 titel:"Technical Mode",
                 desc:"Deep technical questions based on selected role."

                },
                {
                  image:confidenceImg,
                 titel:"Confidence Detection",
                ...
                className='bg-white border border-gray-200 rounded-3xl p-8 shadow-sm hover:shadow-xl transition-all'>
                  <div className='flex items-center justify-between gap-6'>
                     <div className="w-1/2">
                     <h3 className='font-semibold text-xl mb-3'>{mode.titel}</h3>
                     ...
                     <div className='w-1/2 flex justify-end'>
                      <img src={mode.image} alt={mode.title} className='w-28 object-contain' />
                     </div>
